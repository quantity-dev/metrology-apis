...
class Quantity[V, U: Unit](Protocol):
    ...
    def __pow__[R](self: "Quantity[op.CanPow2[op.JustInt | op.JustFloat, R], U]", other: op.JustInt | op.JustFloat, /) -> "Quantity[R, U]": ...
    def __rpow__[R](self: "Quantity[op.CanRPow[op.JustInt | op.JustFloat, R], U]", other: op.JustInt | op.JustFloat, /) -> "Quantity[R, U]": ...
